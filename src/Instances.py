...
class Instances(object):
	...
	def setContPorClase(self, clase, cont):
		self.contPorClase[clase] = cont

	def getContPorClase(self, clase):
		return self.contPorClase[clase]
	...
	def normaliza(self):
		...
		for instance in self.instances:
			for i in range(0, nColumnas):
				#print instance.getElementAtPos(i)
